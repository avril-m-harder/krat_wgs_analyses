...
## Set project name
PROJ=kratroh_08_LD_pruned_bcftoolsroh
...
# | bgzip -c > freqs_krat_final_allfiltcontigs_all_samps_LDpruned.tab.gz
# 
# tabix -s1 -b2 -e2 freqs_krat_final_allfiltcontigs_all_samps_LDpruned.tab.gz
...
# bcftools roh \
# --threads 20 \
# -o krat_final_allfiltcontigs_all_samps_LDpruned_PL.txt \
# --AF-file freqs_krat_final_allfiltcontigs_all_samps_LDpruned.tab.gz \
# krat_final_final_allfiltcontigs_all_samps_LDpruned.recode.vcf.gz
# 
# bcftools roh \
# --threads 20 \
# --GTs-only 30 \
# -o krat_final_allfiltcontigs_all_samps_LDpruned_GT.txt \
# --AF-file freqs_krat_final_allfiltcontigs_all_samps_LDpruned.tab.gz \
# krat_final_final_allfiltcontigs_all_samps_LDpruned.recode.vcf.gz
...
grep "^RG" krat_final_allfiltcontigs_all_samps_LDpruned_GT.txt > \
krat_final_allfiltcontigs_all_samps_LDpruned_GT_RG_ONLY.txt

grep "^RG" krat_final_allfiltcontigs_all_samps_LDpruned_PL.txt > \
krat_final_allfiltcontigs_all_samps_LDpruned_PL_RG_ONLY.txt

cp krat_final_allfiltcontigs_all_samps_LDpruned_GT_RG_ONLY.txt \
/home/amh0254/krat_roh_analyses/06_LD_pruning/

cp krat_final_allfiltcontigs_all_samps_LDpruned_PL_RG_ONLY.txt \
/home/amh0254/krat_roh_analyses/06_LD_pruning/
